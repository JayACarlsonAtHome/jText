...
// under jText::v002 from the shared declaration fragment (jText.api.inc);
// the out-of-line definitions live in the companion implementation unit
// (jText.v002.importstd.impl.cpp). This replaces the textual partition
